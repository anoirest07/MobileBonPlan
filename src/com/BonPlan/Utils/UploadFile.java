...
public class UploadFile {
    ...
    public static String uploadImage(String filePath, String oldName) throws Exception {
        try {
            ...
            connReq.setUrl("http://localhost/symfony/web/app_dev.php/expeval/upimg");
        ...
        String url;
        if (oldName != null) {
            url = "http://localhost/symfony/uploadImagesMob.php?old=" + oldName;
        } else {
            url = "http://localhost/symfony/uploadImagesMob.php";
        }
