 ...
 * @author Yassine
 */
public class AfficheOffreClient extends SideMenuBaseForm{
Container f;
    Form  f2;
    Label lb1;
    Label lb3, lb4, label;
    ...
    public AfficheOffreClient(Resources res, int idetab) {
        super(BoxLayout.y());
...
//            add.getForm().show();
        ...
        ArrayList<Offre> lis = serviceOff.getListOffClient(idetab);
//        f.add(btnajout);
